...
${OBJECTDIR}/src/ast/FuncDefinition.o: src/ast/FuncDefinition.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/ast
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ast/FuncDefinition.o src/ast/FuncDefinition.cpp
...
${OBJECTDIR}/src/ast/InstrSequence.o: src/ast/InstrSequence.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/ast
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ast/InstrSequence.o src/ast/InstrSequence.cpp
